...
Given that we can bring down the input bandwidth the achieved performance will be 298 MB/s, which is lower than 355. To deal with this we can look for other ways to increase throughput of hardware or follow a simple approach of duplicating hardware. Said in heterogeneous computing terminology we can increase the number of compute unit.   
